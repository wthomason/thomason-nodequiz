...
module.exports = "\r\n\r\n<div style=\"width: 50%; margin-top: 12%; margin-left: 20%;\" fxLayout=\"column\">\r\n  <mat-card class=\"mat-elevation-z8\">\r\n      <mat-card-title>Please enter Employee ID</mat-card-title>\r\n      <mat-card-content>\r\n          <form [formGroup]=\"form\" (ngSubmit)=\"login(); form.reset();\" #loginForm>\r\n              <mat-card style=\"width: 50%; margin: 0 auto;\">\r\n                  <mat-card-content fxLayout=\"column\" fxLayoutGap=\"10px\">\r\n\r\n\r\n\r\n                      <small *ngIf=\"errorMessage\">{{ errorMessage }}<br/></small>\r\n                      <small *ngIf=\"form.controls['employeeId'].hasError('required') && form.controls['employeeId'].touched\">employee Id number is a required field</small>\r\n                      <small *ngIf=\"form.controls['employeeId'].hasError('pattern') && form.controls['employeeId'].touched\">employee Id number must be an Integer value.</small>\r\n                      <mat-form-field fxFlex>\r\n                          <input type=\"text\" matInput [formControl]=\"form.controls['employeeId']\" placeholder=\"1234\" />\r\n                          <mat-hint>Only Numbers</mat-hint>\r\n                      </mat-form-field>\r\n\r\n                  </mat-card-content>\r\n                  <mat-card-actions>\r\n                      <button fxFlex mat-raised-button color=\"primary\" [disabled]=\"!form.valid\" type=\"submit\">Submit</button>\r\n                  </mat-card-actions>\r\n              </mat-card>\r\n          </form>\r\n          <br /><br />\r\n      </mat-card-content>\r\n  </mat-card>\r\n</div>\r\n"
...
/* harmony import */ var _pages_presentation_presentation_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./pages/presentation/presentation.component */ "./src/app/pages/presentation/presentation.component.ts");
...
/* harmony import */ var _pages_quiz_quiz_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./pages/quiz/quiz.component */ "./src/app/pages/quiz/quiz.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _pages_presentation_presentation_component__WEBPACK_IMPORTED_MODULE_14__["PresentationComponent"],
                _pages_quiz_quiz_component__WEBPACK_IMPORTED_MODULE_16__["QuizComponent"]
            ],
            imports: [
...
/* harmony import */ var _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/auth-layout/auth-layout.component */ "./src/app/shared/auth-layout/auth-layout.component.ts");
...
/* harmony import */ var _pages_cumulative_summary_cumulative_summary_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/cumulative-summary/cumulative-summary.component */ "./src/app/pages/cumulative-summary/cumulative-summary.component.ts");
...
var AppRoutes = [
    {
        path: '',
        component: _shared_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_1__["AuthLayoutComponent"],
        children: [
            {
                path: '',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: _pages_cumulative_summary_cumulative_summary_component__WEBPACK_IMPORTED_MODULE_7__["CumulativeSummaryComponent"],
                canActivate: [_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
            }
        ]
    },
...
module.exports = "table {\r\n  font-family: arial, sans-serif;\r\n  border-collapse: collapse;\r\n  width: 100%;\r\n}\r\n\r\ntd, th {\r\n  border: 1px solid #dddddd;\r\n  text-align: left;\r\n  padding: 8px;\r\n}\r\n\r\ntr:nth-child(even) {\r\n  background-color: #dddddd;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CumulativeSummaryComponent = /** @class */ (function () {
    function CumulativeSummaryComponent(route, cookieService, http, router, fb, location) {
        ...
        this.http.get('/api/summary/all').subscribe(function (res) {
            if (res) {
                return _this.summaries = res;
            }
            else {
                return _this.errorMessage = "OH NO, I couldn't find the summaries!!!";
            }
        });
    }
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.http.get('/api/quizzes/all').subscribe(function (res) {
            if (res) {
                ...
                return _this.errorMessage = "OH NO, there were no quizzes were found!!!";
            }
        });
    }; //end of ngOnInit
    DashboardComponent.prototype.presentationPage = function (id) {
...
module.exports = "small {\r\n  color: red;\r\n}\r\n.result-msg {\r\n  text-align: center;\r\n  color: steelblue;\r\n  font-weight: bold;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PresentationComponent = /** @class */ (function () {
    function PresentationComponent(route, http, router, location) {
        var _this = this;
        this.route = route;
        this.http = http;
        this.router = router;
        ...
        this.http.get('/api/quizzes/' + this.urlParamId).subscribe(function (res) {
            if (res) {
                ...
                return _this.errorMessage = "OH NO, I couldn't find the quiz!!!";
            }
        });
    }
    PresentationComponent.prototype.quizPage = function (id) {
        this.router.navigateByUrl('/dashboard/quiz/' + id);
    };
    PresentationComponent.prototype.ngOnInit = function () {
    };
    PresentationComponent.prototype.backPage = function () {
        this.location.back();
    };
...
module.exports = ".quiz-radio-group {\r\n  display: -webkit-box;\r\n  display: flex;\r\n  -webkit-box-orient: vertical;\r\n  -webkit-box-direction: normal;\r\n          flex-direction: column;\r\n  margin: 15px 0;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var QuizComponent = /** @class */ (function () {
    function QuizComponent(route, cookieService, http, router, fb, location) {
        var _this = this;
        this.route = route;
        this.cookieService = cookieService;
        this.http = http;
        ...
        this.isShown = false;
        this.quizSummary = [];
        this.topPosToStartShowing = 100; //scroll to top
        this.urlParamId = route.snapshot.paramMap.get('quizId');
    ...
    QuizComponent.prototype.backPage = function () {
        this.location.back();
    };
    QuizComponent.prototype.show = function () {
        this.isShown = !this.isShown;
    };
    QuizComponent.prototype.checkScroll = function () {
        // window의 scroll top
    ...
    QuizComponent.prototype.gotoTop = function () {
        window.scroll({
            top: 0,
            left: 0,
            behavior: 'smooth'
    ...
    QuizComponent.prototype.onSubmit = function (form) {
        ...
        var questionCount = this.quiz.questions.length;
    ...
    ], QuizComponent.prototype, "checkScroll", null);
